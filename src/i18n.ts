...
export const en = {
  ...
  diagram: {
    ...
    svg: "Open the SVG",
    hint: "Editable in draw.io (Arabic and English pages). Scroll the frame sideways, or click the picture to open it full size.",
...
export const ar: Dict = {
  ...
  diagram: {
    kicker: "مخطط المشروع",
    title: "المشروع كله في صورة واحدة.",
    subtitle:
      "كل جزء وكيف يكلّم الأجزاء الثانية: اللعبة، جدار حماية ويندوز، واجهة البرنامج ونواته ووحداته، قائمة سيرفرات stormy، مناطق Blizzard، ومستودعات النسخة العربية وإصداراتها وموقعها.",
    open: "افتح في draw.io",
    download: "تحميل ملف .drawio",
    svg: "افتح صورة SVG",
    hint: "قابل للتعديل في draw.io (صفحة عربية وأخرى إنجليزية). اسحب الإطار جانبًا، أو اضغط الصورة لفتحها بالحجم الكامل.",
    stagesKicker: "مراحل التطوير",
    stagesTitle: "من البرنامج الأصلي إلى اليوم.",
    stagesSubtitle: "كل مرحلة مرّت بها النسخة العربية، مع صورة لشكلها وقتها.",
  },
  gallery: {
    kicker: "لقطات",
    title: "نظرة أقرب.",
  ...
  footer: {
    ...
    made: "النسخة العربية واللانشر وهذا الموقع من تطوير ريان الأثلاوي · البرنامج الأصلي من stormy.",
    source: "كود الموقع",
