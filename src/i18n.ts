...
export const en = {
  ...
  diagram: {
    ...
    svg: "Open the SVG",
    hint: "Editable in draw.io (Arabic and English pages plus a stages page). Scroll sideways on a phone.",
...
export const ar: Dict = {
  ...
  diagram: {
    ...
    svg: "افتح صورة SVG",
    hint: "قابل للتعديل في draw.io (صفحة عربية وأخرى إنجليزية وصفحة للمراحل). على الجوال اسحب الصورة جانبًا.",
